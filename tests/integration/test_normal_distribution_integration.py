...
class TestNormalDistributionIntegration:
    ...
    def test_large_dataset_analysis(self):
        ...
        large_snapshot = DepthSnapshot(
            ...
            bids=[
                DepthLevel(
                    price=Decimal(str(100000 - i)), quantity=Decimal(str(0.1 * (i + 1)))
                )
                for i in range(100)  # 100 bid levels
            ],
            asks=[
                DepthLevel(
                    price=Decimal(str(100001 + i)),
                    quantity=Decimal(str(0.1 * (101 - i))),
                )
    ...
    def test_realistic_btc_fdUSD_scenario(self):
        ...
        realistic_snapshot = DepthSnapshot(
            ...
            bids=[
                ...
                DepthLevel(
                    price=Decimal("69983.0"), quantity=Decimal("2.11")
                ),  # Peak bid
            ...
            asks=[
                ...
                DepthLevel(
                    price=Decimal("69988.0"), quantity=Decimal("2.89")
                ),  # Peak ask
        ...
        for hour in range(3):  # 3 hours of data
            for minute in range(60):
                ...
                for price_offset in range(-5, 6):
                    ...
                    minute_data.price_levels[price_level_data.price_level] = (
                        price_level_data
                    )
