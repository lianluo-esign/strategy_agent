...
class TestDepthSnapshot:
    ...
    def test_get_best_bid(self):
        ...
        snapshot = DepthSnapshot(symbol="BTCFDUSD", timestamp=datetime.now(), bids=bids)
    ...
    def test_get_best_ask(self):
        ...
        snapshot = DepthSnapshot(symbol="BTCFDUSD", timestamp=datetime.now(), asks=asks)

        assert snapshot.get_best_ask() == Decimal("50001.00")

    def test_empty_order_book(self):
        """Test empty order book handling."""
        snapshot = DepthSnapshot(symbol="BTCFDUSD", timestamp=datetime.now())
...
class TestMarketAnalysisResult:
    ...
    def test_market_analysis_result_creation(self):
        ...
        timestamp = datetime.now()
        result = MarketAnalysisResult(timestamp=timestamp, symbol="BTCFDUSD")
...
class TestModelEdgeCases:
    ...
    def test_minute_trade_data_to_dict(self):
        ...
        price_level = PriceLevelData(
            price_level=Decimal("50000"), total_volume=Decimal("1.5")
        )
