...
class TestDepthSnapshotConfigUpdate:
    ...
    def test_depth_snapshot_config_custom_values(self):
        ...
        config = DepthSnapshotConfig(limit=1000, update_interval_seconds=30)
    ...
    def test_config_serialization(self):
        ...
        config = DepthSnapshotConfig(limit=1500, update_interval_seconds=90)
    ...
    def test_config_deserialization_from_dict(self):
        ...
        data = {"limit": 2500, "update_interval_seconds": 75}
    ...
    def test_config_copy_with_modification(self):
        ...
        original = DepthSnapshotConfig(limit=4000, update_interval_seconds=120)
    ...
    def test_settings_load_from_updated_config(self, mock_yaml_load, mock_path_exists):
        ...
        mock_yaml_load.return_value = {
            "data_collector": {
                "depth_snapshot": {"limit": 3000, "update_interval_seconds": 45}
            },
            "redis": {"host": "localhost", "port": 6379, "db": 0},
            "binance": {"symbol": "BTCFDUSD", "timeout": 30},
            "analyzer": {"deepseek": {"api_key": "test-key"}},
        }
