...
class TestNormalDistributionAnalyzer:
    ...
    def test_find_peak_interval_basic(self):
        ...
        mean_price, lower_bound, upper_bound = self.analyzer.find_peak_interval(
            price_quantities
        )
    ...
    def test_analyze_distribution_peaks(self):
        ...
        results = self.analyzer.analyze_distribution_peaks(
            aggregated_bids, aggregated_asks
        )
...
class TestIntegration:
    ...
    def test_analysis_with_insufficient_data(self):
        ...
        minimal_data = {"bids": [(100.0, 0.1)], "asks": [(101.0, 0.1)]}
