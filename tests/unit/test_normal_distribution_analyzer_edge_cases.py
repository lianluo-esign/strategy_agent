...
class TestEdgeCases:
    ...
    def test_duplicate_prices(self):
        ...
        duplicate_data = {
            "bids": [
                ...
                (100.5, 2.0),
                (100.2, 1.5),
            ],  # All aggregate to 100.0
            "asks": [
                (102.0, 2.0),
                (102.8, 1.0),
                (102.3, 0.8),
            ],  # All aggregate to 102.0
        }
    ...
    def test_negative_prices(self):
        ...
        assert result["aggregated_asks"]
        assert (
            result["spread_analysis"]["best_bid"]
            < result["spread_analysis"]["best_ask"]
        )
    ...
    def test_convert_decimal_format_edge_cases(self):
        ...
        analysis_with_none = {
            ...
            "spread_analysis": {"best_bid": 100.0, "best_ask": 102.0},
        }
