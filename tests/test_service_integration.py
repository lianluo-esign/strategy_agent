...
class TestServiceIntegration:
    ...
    def test_journal_logs_command(self, mock_run, service_name):
        ...
        assert "strategy-agent-data-collector" in result.stdout, (
            "Logs should contain service name"
        )
    ...
    def test_directory_permissions(self, project_root):
        ...
        assert os.access(logs_dir, os.R_OK | os.W_OK), (
            "Logs directory should be readable and writable"
        )
        assert os.access(storage_dir, os.R_OK | os.W_OK), (
            "Storage directory should be readable and writable"
        )
